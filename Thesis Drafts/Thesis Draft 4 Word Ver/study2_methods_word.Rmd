...
Participants were 412 students enrolled in Psychology 1000 at a Midwestern University. They were primarily white (76%), female (66%), and freshmen (74%); further demographic information can be found in the table above. Participants received course credit for participation in the study. 

```{r study2_methods_demographics, eval=FALSE, message=FALSE, include=FALSE}

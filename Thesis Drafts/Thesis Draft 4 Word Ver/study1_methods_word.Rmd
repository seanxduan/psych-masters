...
Our participants were 189 students enrolled in a Psychology course at a Midwestern University. Our participants were primarily white (76%), female (68%), and freshmen (80%); further demographic information can be found in the table above. Participants received course credit for participation in the study. 

```{r study1_methods_demographics, eval=FALSE, message=FALSE, include=FALSE }
s1_d %>%
  tbl_summary(
    by = condition,
    type = "Age" ~ "continuous",
...
```{r study_1_demog_1_alt, echo=FALSE, out.width="75%", fig.cap="Demographic information for Study 1"}
knitr::include_graphics("study1_demog.png")
```
